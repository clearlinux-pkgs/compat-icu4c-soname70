...
#
# Source0 file verified with key 0x5F56E5AFA63CCD33 (ccornelius@google.com)
#
Name     : compat-icu4c-soname70
Version  : 70.1
Release  : 39
...
Requires: compat-icu4c-soname70-lib = %{version}-%{release}
Requires: compat-icu4c-soname70-license = %{version}-%{release}
...
%package lib
Summary: lib components for the compat-icu4c-soname70 package.
Group: Libraries
Requires: compat-icu4c-soname70-license = %{version}-%{release}

%description lib
lib components for the compat-icu4c-soname70 package.


%package lib32
Summary: lib32 components for the compat-icu4c-soname70 package.
Group: Default
Requires: compat-icu4c-soname70-license = %{version}-%{release}

%description lib32
lib32 components for the compat-icu4c-soname70 package.


%package license
Summary: license components for the compat-icu4c-soname70 package.
Group: Default

%description license
license components for the compat-icu4c-soname70 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683486446
...
export SOURCE_DATE_EPOCH=1683486446
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-icu4c-soname70
cp %{_builddir}/icu/LICENSE %{buildroot}/usr/share/package-licenses/compat-icu4c-soname70/dbcb5c4a57f45a48c971c06928a7c99fb5656f06 || :
cp %{_builddir}/icu/license.html %{buildroot}/usr/share/package-licenses/compat-icu4c-soname70/06e7821c4127e21850f5c981698443b6f31e0ef1 || :
pushd ../build32/source
%make_install32
...
rm -f %{buildroot}*/V3/usr/lib64/libicudata.so
rm -f %{buildroot}*/V3/usr/lib64/libicui18n.so
rm -f %{buildroot}*/V3/usr/lib64/libicuio.so
rm -f %{buildroot}*/V3/usr/lib64/libicutest.so
rm -f %{buildroot}*/V3/usr/lib64/libicutu.so
rm -f %{buildroot}*/V3/usr/lib64/libicuuc.so
...
rm -f %{buildroot}*/usr/lib32/icu/70.1/Makefile.inc
rm -f %{buildroot}*/usr/lib32/icu/70.1/pkgdata.inc
...
rm -f %{buildroot}*/usr/lib64/icu/70.1/Makefile.inc
rm -f %{buildroot}*/usr/lib64/icu/70.1/pkgdata.inc
...
rm -f %{buildroot}*/usr/share/icu/70.1/LICENSE
rm -f %{buildroot}*/usr/share/icu/70.1/config/mh-linux
rm -f %{buildroot}*/usr/share/icu/70.1/install-sh
rm -f %{buildroot}*/usr/share/icu/70.1/mkinstalldirs
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libicudata.so.70
/V3/usr/lib64/libicudata.so.70.1
/V3/usr/lib64/libicui18n.so.70
/V3/usr/lib64/libicui18n.so.70.1
/V3/usr/lib64/libicuio.so.70
/V3/usr/lib64/libicuio.so.70.1
/V3/usr/lib64/libicutest.so.70
/V3/usr/lib64/libicutest.so.70.1
/V3/usr/lib64/libicutu.so.70
/V3/usr/lib64/libicutu.so.70.1
/V3/usr/lib64/libicuuc.so.70
/V3/usr/lib64/libicuuc.so.70.1
...
/usr/share/package-licenses/compat-icu4c-soname70/06e7821c4127e21850f5c981698443b6f31e0ef1
/usr/share/package-licenses/compat-icu4c-soname70/dbcb5c4a57f45a48c971c06928a7c99fb5656f06
